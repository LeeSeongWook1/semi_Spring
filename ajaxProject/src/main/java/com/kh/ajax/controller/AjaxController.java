...
//		List<Menu> menus = menuService.findAll();
		...
		menus.add(new Menu(1,"아구찜",55000,"아구"));
		menus.add(new Menu(2,"알/고니찜",55000,"알/고니"));
		menus.add(new Menu(3,"동태탕",45000,"동태"));
		
		//-------------여기까지가DB에서 조회해온 Menu드이 담겨있는 List
		
		// 1. 반복문 사용 할 것 + 2. 같은 행의 데이터는 같이 사용할 것
