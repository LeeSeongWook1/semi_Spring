...
public class AirVO {
	...
	private String statitonName; // 측정소명
	...
	public String getStatitonName() {
		return statitonName;
	}
	public void setStatitonName(String statitonName) {
		this.statitonName = statitonName;
	}
	...
	public String toString() {
		return "AirVO [statitonName=" + statitonName + ", dataTime=" + dataTime + ", so2Value=" + so2Value
				+ ", pm10Value=" + pm10Value + ", o3Value=" + o3Value + ", khaiValue=" + khaiValue + "]";
	}
	public AirVO(String statitonName, String dataTime, String so2Value, String pm10Value, String o3Value,
			String khaiValue) {
		super();
		this.statitonName = statitonName;
		this.dataTime = dataTime;
	...
	public AirVO(String statitonName, String dataTime, String so2Value, String pm10Value, String o3Value,
			String coGrade, String khaiValue) {
		super();
		this.statitonName = statitonName;
		this.dataTime = dataTime;
		this.so2Value = so2Value;
